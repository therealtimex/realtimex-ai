          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 animate-slide-up animation-delay-400">
              ...
              <Button
                variant="outline"
                size="lg"
                className="px-8 py-3 text-lg bg-white dark:bg-transparent text-gray-900 dark:text-white border-gray-200 dark:border-dark-purple hover:bg-gray-50 dark:hover:bg-dark-purple/10 transition-all duration-300 hover:scale-105"
              >
                Schedule a Demo
              </Button>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-16 h-16 bg-blue-500 dark:bg-dark-purple text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-6">
                  {step.number}
                </div>
